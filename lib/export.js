...
console.info('Settting environmental variables.');
console.info('STATIC_SERVER = ' + AWS_STATIC_BUCKET_NAME + '.s3.amazonaws.com');
console.info('STATIC_PATH = ' + STATIC_PATH);
console.info('ASSETS_HOST = ' + 'https://' + AWS_STATIC_BUCKET_NAME + '.s3.amazonaws.com/' + STATIC_PATH);
...
console.info('profile.d updated');
